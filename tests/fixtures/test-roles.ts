...
export const TEST_AGENT_ROLES: AgentRole[] = [
  ...
  { name: 'pixel', role: 'designer', description: 'Test designer', affinityTags: ['dashboard', 'ui', 'css', 'visual', 'animation', 'frontend', 'layout', 'ux', 'modal', 'chart'], alwaysRoute: ['ui', 'ux', 'dashboard'], neverRoute: ['infra'], wipCap: 1 },
