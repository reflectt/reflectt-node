...
const ACTIVE_CONTEXT_SYNC_MS = 5 * 60_000   // 5 min proactive context sync when active
const IDLE_CONTEXT_SYNC_MS = 30 * 60_000    // 30 min proactive context sync when idle
