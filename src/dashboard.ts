...
<style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .kanban-col-header .cnt { font-weight: 400; font-size: var(--text-sm); background: var(--border); padding: 1px 7px; border-radius: 8px; }
  ...
  .modal-close {
    ...
    font-size: var(--text-xl); padding: 0; width: 24px; height: 24px;
  }
  ...
  .artifact-path { font-family: ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, 'Liberation Mono', 'Courier New', monospace; font-size: var(--text-sm2); color: var(--text-bright); }
  ...
  .status-btn {
    padding: 6px 14px; font-size: var(--text-sm2); font-weight: 600; border-radius: var(--radius-sm);
  ...
  .assignee-tag { font-size: var(--text-sm); color: var(--text-muted); display: flex; align-items: center; gap: 4px; }
  .assignee-tag .role-small { font-size: var(--text-2xs); color: var(--purple); background: rgba(180, 142, 255, 0.08); padding: 1px 5px; border-radius: 3px; text-transform: uppercase; letter-spacing: 0.3px; }
  .done-toggle { font-size: var(--text-sm2); color: var(--text-muted); background: none; border: none; cursor: pointer; padding: 4px 0; }
  ...
  .channel-tab {
    padding: 6px 12px; font-size: var(--text-sm2); border-radius: var(--radius-sm) var(--radius-sm) 0 0;
  ...
  .event-row { padding: 6px 0; border-bottom: 1px solid var(--border-subtle); font-size: var(--text-sm2); display: flex; align-items: center; gap: 8px; }
  ...
  .ssot-meta {
    ...
    border-radius: var(--radius-sm); background: var(--surface-raised); font-size: var(--text-sm2);
  }
  ...
  .ssot-item-label { font-size: var(--text-sm2); color: var(--text); }
  .ssot-link {
    color: var(--accent); text-decoration: none; font-size: var(--text-sm2); font-weight: 600;
  }
  ...
  .blocker-item {
    ...
    border-radius: var(--radius-sm); margin-bottom: 6px; font-size: var(--text-sm2);
  }
  ...
  .sla-chip {
    border: 1px solid var(--border); border-radius: var(--radius-sm); padding: 8px 10px; font-size: var(--text-sm2);
  ...
  .compliance-table th, .compliance-table td { text-align: left; padding: 8px; font-size: var(--text-sm2); border-bottom: 1px solid var(--border-subtle); }
  ...
  .review-item-meta { font-size: var(--text-sm); color: var(--text-muted); margin-top: 2px; display: flex; gap: 8px; flex-wrap: wrap; }
  ...
  .incident-item {
    ...
    padding: 8px 10px; margin-bottom: 6px; font-size: var(--text-sm2);
  }
  ...
  @media (max-width: 420px) {
    ...
    .task-title { font-size: var(--text-sm2); }
    .msg { padding: 5px 0; }
    .msg-header { gap: 4px; }
  ...
  .focus-toggle {
    ...
    padding: 5px 12px; border-radius: var(--radius-full); font-size: var(--text-sm2); font-weight: 600;
  ...
  .feedback-card .fb-message {
    font-size: var(--text-sm2); color: var(--text-bright); margin-top: 4px; line-height: 1.4;
  }
  .feedback-card .fb-footer {
    display: flex; align-items: center; gap: 8px; margin-top: 6px; font-size: var(--text-xs);
  }
  ...
  .approval-card .approval-title { font-size: var(--text-sm2); font-weight: 600; color: var(--text-bright); flex: 1; }
  ...
  .approval-card .confidence-score {
    font-size: var(--text-sm); font-weight: 700; padding: 2px 6px; border-radius: 8px;
  }
  ...
  .policy-agent-card .weight-row {
    display: flex; align-items: center; gap: 8px; margin-top: 8px; font-size: var(--text-sm);
  }
  ...
  .pr-review-section-title {
    font-size: var(--text-sm2); font-weight: 600; color: var(--text-bright);
  ...
  .criterion-row .criterion-text { font-size: var(--text-sm2); color: var(--text-bright); margin-bottom: 4px; display: flex; align-items: flex-start; gap: 6px; }
  ...
  .confidence-badge {
    ...
    font-size: var(--text-2xs); font-weight: 600; text-transform: uppercase; letter-spacing: 0.3px;
  }
  ...
  .getting-started .gs-step .gs-desc {
    font-size: var(--text-sm2); color: var(--text-muted); line-height: 1.4;
  }
  .getting-started .gs-step .gs-link {
    display: inline-block; margin-top: 4px; font-size: var(--text-sm2);
