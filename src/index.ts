        ...
        if (teamIntent) {
          ...
          taskManager.createTask({
            ...
            description: [
              ...
              '7. Each agent must claim their Reflectt identity by calling `POST /agents/:name/identity/claim` with { claimedName: "their-chosen-name", displayName: "Their Name", voice: "a kokoro voice id", avatar: { type: "svg", content: "<svg viewBox=\'0 0 100 100\'>...</svg>" } }. This is how they appear on the canvas — choose a name, design a unique avatar (colors, shapes, symbols reflecting role and personality), and pick a voice that fits.',
              '',
              'The user should see a working team with named agents and unique avatars when they check the dashboard.',
            ].join('\n'),
            priority: 'P0',
            assignee: 'main',
            done_criteria: [
              ...
              'Each agent has claimed their Reflectt identity (name + avatar + voice) via POST /agents/:name/identity/claim',
