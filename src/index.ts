        ...
        if (teamIntent) {
          ...
          taskManager.createTask({
            ...
            description: [
              ...
              '7. Each agent must claim their Reflectt identity by calling `POST /agents/:name/identity/avatar` with a unique avatar they design themselves (SVG preferred, viewBox "0 0 100 100", type: "svg", content: "<svg>..."). This is how they appear on the canvas — use colors, shapes, and symbols that reflect their role and personality.',
              '',
            ...
            done_criteria: [
              ...
              'Each agent has claimed their Reflectt identity via POST /agents/:name/identity/avatar',
