...
import getTableSchema, { GetTableSchemaInput } from './implementation'
...
describe('getTableSchema', () => {
  ...
  describe('Happy Path', () => {
    it('should execute successfully with valid input', async () => {
      const input: GetTableSchemaInput = {
        // TODO: Add test input
      }

      const result = await getTableSchema(input, tempDataDir, tempGlobalDir)
