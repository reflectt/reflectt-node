...
import upsertTableSchema, { UpsertTableSchemaInput } from './implementation'

describe('upsertTableSchema', () => {
  ...
  describe('Happy Path', () => {
    it('should execute successfully with valid input', async () => {
      const input: UpsertTableSchemaInput = {
        // TODO: Add test input
      }

      const result = await upsertTableSchema(input, tempDataDir, tempGlobalDir)
