...
import createTaskRun, { CreateTaskRunInput } from './implementation'
...
describe('createTaskRun', () => {
  ...
  describe('Happy Path', () => {
    it('should execute successfully with valid input', async () => {
      const input: CreateTaskRunInput = {
        // TODO: Add test input
      }

      const result = await createTaskRun(input, tempDataDir, tempGlobalDir)
