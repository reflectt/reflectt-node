...
import getTaskRunStats, { GetTaskRunStatsInput } from './implementation'

describe('getTaskRunStats', () => {
  ...
  describe('Happy Path', () => {
    it('should execute successfully with valid input', async () => {
      const input: GetTaskRunStatsInput = {
        // TODO: Add test input
      }

      const result = await getTaskRunStats(input, tempDataDir, tempGlobalDir)
