...
import recordToolUse, { RecordToolUseInput } from './implementation'
...
describe('recordToolUse', () => {
  ...
  describe('Happy Path', () => {
    it('should execute successfully with valid input', async () => {
      const input: RecordToolUseInput = {
        // TODO: Add test input
      }

      const result = await recordToolUse(input, tempDataDir, tempGlobalDir)
