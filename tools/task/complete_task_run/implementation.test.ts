...
import completeTaskRun, { CompleteTaskRunInput } from './implementation'
...
describe('completeTaskRun', () => {
  ...
  describe('Happy Path', () => {
    it('should execute successfully with valid input', async () => {
      const input: CompleteTaskRunInput = {
        // TODO: Add test input
      }

      const result = await completeTaskRun(input, tempDataDir, tempGlobalDir)
