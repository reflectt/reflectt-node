...
import getWorkflowStatus, { GetWorkflowStatusInput } from './implementation'
...
describe('getWorkflowStatus', () => {
  ...
  describe('Happy Path', () => {
    it('should execute successfully with valid input', async () => {
      const input: GetWorkflowStatusInput = {
        // TODO: Add test input
      }

      const result = await getWorkflowStatus(input, tempDataDir, tempGlobalDir)
