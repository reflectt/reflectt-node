...
import deleteStorageFile, { DeleteStorageFileInput } from './implementation'
...
describe('deleteStorageFile', () => {
  ...
  describe('Happy Path', () => {
    it('should execute successfully with valid input', async () => {
      const input: DeleteStorageFileInput = {
        // TODO: Add test input
      }

      const result = await deleteStorageFile(input, tempDataDir, tempGlobalDir)
