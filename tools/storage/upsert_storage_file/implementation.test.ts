...
import upsertStorageFile, { UpsertStorageFileInput } from './implementation'

describe('upsertStorageFile', () => {
  ...
  describe('Happy Path', () => {
    it('should execute successfully with valid input', async () => {
      const input: UpsertStorageFileInput = {
        // TODO: Add test input
      }

      const result = await upsertStorageFile(input, tempDataDir, tempGlobalDir)
