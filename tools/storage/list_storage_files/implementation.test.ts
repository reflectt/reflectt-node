...
import listStorageFiles, { ListStorageFilesInput } from './implementation'
...
describe('listStorageFiles', () => {
  ...
  describe('Happy Path', () => {
    it('should execute successfully with valid input', async () => {
      const input: ListStorageFilesInput = {
        // TODO: Add test input
      }

      const result = await listStorageFiles(input, tempDataDir, tempGlobalDir)
