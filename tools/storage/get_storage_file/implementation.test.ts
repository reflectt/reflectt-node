...
import getStorageFile, { GetStorageFileInput } from './implementation'
...
describe('getStorageFile', () => {
  ...
  describe('Happy Path', () => {
    it('should execute successfully with valid input', async () => {
      const input: GetStorageFileInput = {
        // TODO: Add test input
      }

      const result = await getStorageFile(input, tempDataDir, tempGlobalDir)
